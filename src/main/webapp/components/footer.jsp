...
<footer class="bg-bg400 rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 bg-bg100 antialiased " >
    <p class="mb-4 text-sm text-center text-text100 sm:mb-0">
        &copy;2024<a href="#" class="hover:underline" target="_blank">Manos Mexicanas</a>. Derechos reservados.
    </p>
    <div class="flex justify-center items-center space-x-1">
        <a href="#" data-tooltip-target="tooltip-facebook" class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-600">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 2H15C13.6739 2 12.4021 2.52678 11.4645 3.46447C10.5268 4.40215 10 5.67392 10 7V10H7V14H10V22H14V14H17L18 10H14V7C14 6.73478 14.1054 6.48043 14.2929 6.29289C14.4804 6.10536 14.7348 6 15 6H18V2Z" stroke="#30A380" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
