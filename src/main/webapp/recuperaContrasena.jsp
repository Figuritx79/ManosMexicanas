        ...
        <div class="container sm:mt-40 mt-24 my-auto max-w-md border-2 border-gray-200 rounded-[20px] p-3 bg-primary-gray-200">
            ...
            <div class="m-6">
                <form class="mb-4">
                    ...
                    <div class="mb-6">
                        <button type="button" class="w-full px-3 py-4 text-white bg-primary100 rounded-md hover:bg-teal-600 focus:outline-none duration-100 ease-in-out">Enviar enlace de reinicio</button>
                    </div>
