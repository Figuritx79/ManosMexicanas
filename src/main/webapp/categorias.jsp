...
<main>
    <section class="flex justify-center items-start py-16">
        <div class="w-11/12 md:w-3/4 lg:w-3/4 flex flex-col lg:flex-row">
            <aside class="lg:w-1/4 w-full bg-gray-100 p-4 rounded-lg shadow-lg">
                <h1 class="text-3xl font-bold mb-4">Nombre (producto)</h1>
                <p class="text-gray-600">123 resultados</p>
                <div class="flex items-center space-x-4 mt-4">
                    <div class="lg:w-3/4 w-full lg:ml-4 mt-4 lg:mt-0 bg-white p-4 rounded-lg shadow-lg">
